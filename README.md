...
**Foundation models** (`--foundation-model {dinov3_vitl16, medsiglip_448, uni2_h}`)
are large, **gated** Hugging Face repos. Before using one of them:
1. Log into Hugging Face with your own account and accept the license /
   ...
   [UNI2-h](https://huggingface.co/MahmoodLab/UNI2-h) (UNI2-h approval requires
   your account email to match an institutional address, and isn't instant).
